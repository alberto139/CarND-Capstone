...
// reducing the odds to have name collisions with Windows.h 
  ...
  #undef OVERRIDE
#endif
#if defined(_WIN32) && defined(ROTARY_LOW)
  #undef ROTARY_LOW
#endif
#if defined(_WIN32) && defined(ROTARY_PARK)
  #undef ROTARY_PARK
#endif
...
bool operator==(const ::dbw_mkz_msgs::GearReject_<ContainerAllocator1> & lhs, const ::dbw_mkz_msgs::GearReject_<ContainerAllocator2> & rhs)
{
