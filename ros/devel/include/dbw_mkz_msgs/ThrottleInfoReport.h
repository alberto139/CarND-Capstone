...
bool operator==(const ::dbw_mkz_msgs::ThrottleInfoReport_<ContainerAllocator1> & lhs, const ::dbw_mkz_msgs::ThrottleInfoReport_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.throttle_pc == rhs.throttle_pc &&
    lhs.throttle_rate == rhs.throttle_rate &&
