...
bool operator==(const ::dbw_mkz_msgs::BrakeInfoReport_<ContainerAllocator1> & lhs, const ::dbw_mkz_msgs::BrakeInfoReport_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.brake_torque_request == rhs.brake_torque_request &&
    lhs.brake_torque_actual == rhs.brake_torque_actual &&
    lhs.wheel_torque_actual == rhs.wheel_torque_actual &&
    lhs.accel_over_ground == rhs.accel_over_ground &&
    lhs.hsa == rhs.hsa &&
    lhs.abs_active == rhs.abs_active &&
    lhs.abs_enabled == rhs.abs_enabled &&
    lhs.stab_active == rhs.stab_active &&
    lhs.stab_enabled == rhs.stab_enabled &&
    lhs.trac_active == rhs.trac_active &&
    lhs.trac_enabled == rhs.trac_enabled &&
