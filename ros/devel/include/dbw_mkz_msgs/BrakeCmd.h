...
// reducing the odds to have name collisions with Windows.h 
  ...
  #undef CMD_TORQUE
#endif
#if defined(_WIN32) && defined(TORQUE_BOO)
  #undef TORQUE_BOO
#endif
...
bool operator==(const ::dbw_mkz_msgs::BrakeCmd_<ContainerAllocator1> & lhs, const ::dbw_mkz_msgs::BrakeCmd_<ContainerAllocator2> & rhs)
{
