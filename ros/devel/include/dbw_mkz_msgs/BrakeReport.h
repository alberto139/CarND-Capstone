...
bool operator==(const ::dbw_mkz_msgs::BrakeReport_<ContainerAllocator1> & lhs, const ::dbw_mkz_msgs::BrakeReport_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.boo_input == rhs.boo_input &&
    lhs.boo_cmd == rhs.boo_cmd &&
    lhs.boo_output == rhs.boo_output &&
