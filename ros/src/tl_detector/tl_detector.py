...
class TLDetector(object):
    ...
    def waypoints_cb(self, waypoints):
        ...
        if not self.waypoints_2d:
            print("Setting waypoint_tree")
            self.waypoints_2d = [[waypoint.pose.pose.position.x, waypoint.pose.pose.position.y] for waypoint in waypoints.waypoints]
            print("waypoints_2d: " + str(self.waypoints_2d[:10]))
    ...
    def image_cb(self, msg):
        ...
        used.
        '''
        #TODO: Incorporate yellow light logic
    ...
    def process_traffic_lights(self):
        ...
        line_wp_idx = None     # Closest traffic stop line
        ...
        if(self.pose and self.waypoints):
            ...
            # Iterate to the traffic lights to find the closest one
